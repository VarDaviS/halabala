...
def main():
    pcapname = "trace-5.pcap"
    if pcapname[:3] == "eth":
        file_path = "C:/Users/dadvo/Vysoka/3.Semester/PKS/1.Zadanie/morepythonlearning/eth/"+pcapname
    elif pcapname[:5] == "trace":
        file_path = "C:/Users/dadvo/Vysoka/3.Semester/PKS/1.Zadanie/morepythonlearning/traces/"+pcapname
    else:
...
def Yaml(Packets, hex, pcapname):
    ...
    data = {"name":"PKS2022/23", "pcap_name": pcapname, "packets": b}
